...
const Signin = () => {
  ...
  return (
    <div className="sm:px-0 px-4">
      <div className=" sm:w-7/12  w-full mx-auto  mt-20 border rounded-lg shadow-lg ">
        ...
        <div className="flex items-center justify-center  rounded-md lg:px-6 px-3  ">
          <div className="w-full">
            ...
            <form
              ...
              className="lg:mt-10 md:mt-8 sm:mt-6 mt-4 sm:w-4/5 w-full mx-auto"
            >
          ...
          <div className="flex flex-col items-end justify-start  md:w-full w-0  ">
            <div className="hidden md:block w-full mx-auto lg:py-4 py-2">
              <Link to="/signup" className="xl:text-lg text-sm font-semibold ">
